                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div href="#" class="thumbnail">
                                <a style="text-decoration: none;display: inline-flex;padding: 20px">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div href="#" class="thumbnail">
                                <a style="text-decoration: none;display: inline-flex;padding: 20px">
                                    ...
                                    <p style="display: inline-block;padding: 10px 20px 0 25px;font-size: 20px;font-family:'Microsoft YaHei UI',sans-serif">发布公共</p>
                                </a>
                            </div>
                        </div>
